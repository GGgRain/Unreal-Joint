...
void SJointGraphNodeCompileResult::RebuildWidget()
{
	...
	[
		...
		[
			...
			.ButtonColorAndOpacity(FLinearColor(0.2f, 0.05f, 0.05f, 0.80f))
		...
		[
			...
			.ButtonStyle(FJointEditorStyle::Get(), "JointUI.Button.RoundSolid")
			.Visibility(EVisibility::Collapsed)
			.ButtonColorAndOpacity(FLinearColor(0.2f, 0.1f, 0.05f, 0.80f))
			.ContentPadding(FJointEditorStyle::Margin_Normal)
		...
		[
			...
			.ButtonStyle(FJointEditorStyle::Get(), "JointUI.Button.RoundSolid")
			.Visibility(EVisibility::Collapsed)
			.ButtonColorAndOpacity(FLinearColor(0.02f, 0.02f, 0.02f, 0.80f))
			.ContentPadding(FJointEditorStyle::Margin_Normal)
