...
#define JOINT_MINOR_VERSION 8
#define JOINT_PATCH_VERSION 4
...
#define JOINT_VERSION_NEWER_THAN(MajorVersion, MinorVersion, PatchVersion) \
	JOINT_GREATER_SORT(JOINT_MAJOR_VERSION, MajorVersion, JOINT_GREATER_SORT(JOINT_MINOR_VERSION, MinorVersion, UE_GREATER_SORT(JOINT_PATCH_VERSION, PatchVersion, false)))
...
#define JOINT_VERSION_OLDER_THAN(MajorVersion, MinorVersion, PatchVersion) \
	JOINT_GREATER_SORT(MajorVersion, JOINT_MAJOR_VERSION, JOINT_GREATER_SORT(MinorVersion, JOINT_MINOR_VERSION, UE_GREATER_SORT(PatchVersion, JOINT_PATCH_VERSION, false)))
